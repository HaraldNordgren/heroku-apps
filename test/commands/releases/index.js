...
v40  Set foo config v…            jeff@heroku.com  2015/11/18 01:37:41 +0000
...
v40  Set foo config v…   jeff@heroku.com  2015/11/18 01:37:41 +0000
v39  Remove AWS_SECRE…   jeff@heroku.com  2015/11/18 01:36:38 +0000
...
v39  Remove AWS_SEC… release command failed  jeff@heroku.com  2015/11/18 01:36:38 +0000
v38  second comm… release command executing  jeff@heroku.com  2015/11/18 01:36:38 +0000
v37  first commit                            jeff@heroku.com  2015/11/18 01:36:38 +0000
`))
      .then(() => expect(cli.stderr, 'to be empty'))
      .then(() => api.done())
...
v41  third commit                            jeff@heroku.com  2015/11/18 01:36:38 +0000
v40  Set foo config vars                     jeff@heroku.com  2015/11/18 01:37:41 +0000
v39  Remove AWS_SECRET_ACCESS_KEY config …   jeff@heroku.com  2015/11/18 01:36:38 +0000
v38  second commit                           jeff@heroku.com  2015/11/18 01:36:38 +0000
v37  first commit                            jeff@heroku.com  2015/11/18 01:36:38 +0000
`))
      .then(() => expect(cli.stderr, 'to be empty'))
...
`))
  ...
  it('shows extended info', () => {
    ...
    return cmd.run({app: 'myapp', flags: {extended: true}})
      .then(() => expect(cli.stdout, 'to equal', `=== myapp Releases
v40      Set foo config v…   jeff@heroku.com  2015/11/18 01:37:41 +0000  1                 uuid
`))
      .then(() => expect(cli.stderr, 'to be empty'))
      .then(() => api.done())
  })
